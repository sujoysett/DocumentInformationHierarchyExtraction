...
public class Word2JsonConvertor {

	private static int fontSizeBarrier = 11;

	public static void main(String[] args) throws Exception {
		String inputFileName = "documents/sample_test_suite.doc";
		String outputFileName = "documents/TestProcedures.json";

		if (inputFileName.endsWith("docx")) {
			performDocxConv(inputFileName, outputFileName);
		}
		else if(inputFileName.endsWith("doc")) {
			performDocConv(inputFileName, outputFileName);
		} 
		else {
			System.err.println("This input file typr is not handled. ");
		}
	}
	private static void performDocConv(String inputFileName, String outputFileName)  throws Exception{
	...
	private static void performDocxConv(String inputFileName, String outputFileName) throws Exception {
